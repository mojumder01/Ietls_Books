...
export default function WritingManagement() {
  ...
  const handleCSVUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setCsvMessage(`✅ Successfully added ${successCount} writing prompts from CSV!`);
      ...
      <div className="max-w-2xl bg-white dark:bg-slate-800 rounded-lg p-6 shadow">
        ...
        <div className="mt-8 pt-8 border-t border-slate-300 dark:border-slate-600">
          ...
          <div className="space-y-4">
            <button
              onClick={() => downloadCSVTemplate('writing_template.csv', WRITING_CSV_HEADERS)}
...
"Write about a memorable trip",medium,B1,30
"Describe your ideal job",easy,A2,25
"Letter of complaint to a store",hard,B2,40`}
              </pre>
            </div>
          </div>
        </div>
